...
| 10 | **Native-core auto-init** | `zaparoo_is_native_core()` matches core name `"Zaparoo Frontend"`; `zaparoo_alt_launcher_init_for_core()` auto-spawns when the FPGA loads that core | `support/zaparoo/alt_launcher.cpp:480-495`, `user_io.cpp:1543` |
