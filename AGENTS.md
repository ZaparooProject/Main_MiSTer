...
5. **Never touch the Makefile unless strictly necessary.** Makefile conflicts are painful to auto-resolve. Use the existing glob rules instead of adding explicit file references.
